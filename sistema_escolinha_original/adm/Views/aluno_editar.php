...
if(!defined('C7E3L8K9E58743')){
            ...
            <main class="geral-dashboard">
                ...
                <aside class="menu-left">
                    ...
                    <ul>
                        ...
                        <li class="menu_left_item">
                            <a class="link menu_left_link" href="./">Voltar</a>
                        </li>
                    </ul>
                    <a class="link" style="color: rgb(227, 227, 1); ;" href="./home"><i class="fa fa-sign-out icone-sair fa-5x" aria-hidden="true"></i></a>
                </aside>
                <!--fim menu left-->
                <div class="content">
                    <!--menu top-->
    ...
    <?php
   //FAZER COLUNA COM DADOS PESSOAIS, DADOS DO ENDEREÇO E TURMA CADASTRADA 
}
