                                    ...
                                    <div class="inputs-dados-pessoais">
                                        <form action="" method="post">
                                            ...
                                            <div>
                                                ...
                                                <input  type="text" name="cidade" id="cidade" value="<?= $dados['cidade'] ?>" maxlength="100">
                                            </div>
                                            <div>
                                                <label for="Bairro">Bairro</label>
                                                <input  type="text" name="bairro" id="bairro" value="<?= $dados['bairro']?>" maxlength="100">
                                            </div>
                                            <div>
                                                <label for="logradouro">Logradouro</label>
                                                <input  type="text" name="logradouro" id="logradouro" value="<?= $dados['logradouro'] ?>" maxlength="100">
                                            </div>
                                            <div>
